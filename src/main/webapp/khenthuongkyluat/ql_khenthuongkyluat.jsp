                ...
                <div class="row">
                    <div class="container body">
						<form class = "box_form">
							<div class = "col-md-11 box_content">
                				...
                				<div class="form-group form-inline">
                    				...
                    				<textarea class="form-control box_form_control" id="noidung" rows="5" placeholder="Nội dung" name="noidung" required></textarea>
                				</div>
							</div>
						...
						<div class="form_add" id="add_khenthuong">
                        	<form action="/add_khenthuongkyluat" class="form-container">
                            	<h3>Thêm khen thưởng và kỷ luật</h3>
                            	<div class="form-group form-inline">
                                	<label for="matk" class = "label_form_control"><b>Mã nhân viên</b></label>
                                	<input type="text" class="form-control box_form_control" placeholder="Mã nhân viên" name="matk" id = "matk" required>
                            	</div>
                            	<div class="form-group form-inline">
                            	...
                            	<div class="form-group form-inline">
                                	...
                                	<select id="loai" class="form-control box_form_control" class="form-select">
                                    	<option>Khen Thưởng</option>
                                    	<option>Kỷ Luật</option>
                                	</select>
                            	</div>
                            	<div class="form-group form-inline">
                                	<label for="noidung" class = "label_form_control"><b>Nội dung:</b></label>
                                	<textarea type="text" class="form-control box_form_control" class = "form_add_noidung" name="noidung" rows = "5" required> </textarea> 
                            	</div>
